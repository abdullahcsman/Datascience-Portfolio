...
db.Property.find(
     { 
     status: 'sold', location: 'Jesmond', city: 'Newcastle'     } );
...
{ _id: "6", 
  ...
  SoldProperty: {_id: "1", buyer_id: "C8", selling_price: 220000, stump_duty: 20, cm_paid: 2000, selling_date:  ISODate("2021-04-12")}
});
...
db.Property.find(
     { 
     status: 'sold', location: {$in: ['Fenham', 'Gateshead']}, city: 'Newcastle',
     'SoldProperty.selling_date': { $gt: new Date('2018-01-01'), $lt: new Date('2021-12-29') }
     } );
...
{ property_id: "P3", 
  ...
  RentProperty: {rent_id: 'R1', selling_price: 180000, stump_duty: 20, commission_paid: 3000, sold_date:  ISODate("2019-10-28")}
...
{ _id: "4", 
  ...
  RentProperty: {t_id: 'c5', rent_per_month: 600, advance_paid: 2000, date_tenancy_commenced: ISODate("2019-10-28"), date_tenancy_finished:  ISODate("2023-02-26"), commission_paid: 200},
